            ...
            <el-form :model="form" label-width="80px" label-position="left" style="width: 100%">
              ...
              <el-form-item label="后端地址:">
                <el-select v-model="form.customBackend" allow-create filterable @change="selectChanged"
                  placeholder="https://subperuse.fix.qzz.io" style="width: 100%">
  ...
  data() {
    return {
      ...
      options: {
        ...
        shortTypes: {
          "自建": "https://pastebin.2.0.0.0.f.6.0.0.0.7.4.0.1.0.0.2.ip6.arpa/duan",
        ...
        customBackend: {
          "自建自用后端": "https://subperuse.fix.qzz.io",
        ...
        backendOptions: [
          { value: "https://subperuse.fix.qzz.io" },
